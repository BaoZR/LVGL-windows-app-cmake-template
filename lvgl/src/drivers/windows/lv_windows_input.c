...
//                                (translated_key = LV_KEY_SELECT_ALL) : (skip_translation = true);
//                            break;
                        case 'C':
                            (GetAsyncKeyState(VK_CONTROL) < 0) ?
                                (translated_key = LV_KEY_COPY) : (skip_translation = true);
                            break;
                        case 'V':
                            (GetAsyncKeyState(VK_CONTROL) < 0) ?
                                (translated_key = LV_KEY_PASTE) : (skip_translation = true);
                            break;
